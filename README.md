ساختار پیشنهادی:
  1) مقدمه‌ای کوتاه با یک حقیقت شگفت‌انگیز برای جلب توجه (مثلاً دلیل بقای بیش از 400 میلیون ساله کوسه‌ها).
  2) تاریخچه تکاملی: توضیح دهید که کِی و چگونه کوسه‌ها از آبزیان غضروفی شکل گرفته‌اند و چه تفاوتی با دایناسورها دارند.
  3) آناتومی و حس‌های خاص: اسکلت غضروفی، پوست با دنتیکول‌ها، Ampullae of Lorenzini، خط جانبی، حس بویایی قوی و توان تشخیص میدان‌های الکتریکی در آب.
  4) مدل‌های تغذیه: شکارچیان بزرگ (مثلاً کوسه سفید) در برابر فیلترخواران (کوسه نهنگی، basking shark، megamouth) و نحوه فیلتراسیون آب برای تقاضای غذای وسیع.
  5) تولیدمثل: روش‌های oviparous، ovoviviparous و viviparous و تفاوت‌های نسل‌به‌نسل و تاثیر آن بر جمعیت‌ها.
  6) تنوع گونه‌ای و نمونه‌های شاخص: Great White، Whale Shark، Hammerhead، Tiger Shark، Frozen/Megamouth و غیره.
  7) رفتارهای جالب و واقعیت‌های علمی در برابر افسانه‌ها: مهاجرت‌ها، الگوهای شکار، سازگاری با محیط‌های مختلف.
  8) تهدیدات و حفاظت: صید بی‌رویه برای فین‌ها، تخریب زیستگاه، کمبود منابع غذایی و اهمیت حفاظت از زیستگاه‌ها و مدیریت پایدار صید.
  9) نتیجه‌گیری و پرسش تفکری برای مخاطب.
- نکته‌های نگارشی: هر بخش را با یک حقیقت جالب پایان بده و از زبان ساده و تصاویر ذهنی استفاده کن تا مخاطب به محتوای علمی پیوسته علاقه‌مند بماند.
- پایان: یک سوال REFLECTIVE برای تشویق به تفکر، مثلاً “اگر می‌خواستید یک برنامه حفاظتی برای یک اکوسیستم دریایی طراحی کنید، مهم‌ترین اقدام از نظر شما چیست؟” align="center">
